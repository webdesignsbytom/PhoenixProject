...
const contactForms = [
  {
    ...
    hardLimits: 'No blood play, no scat.',
    interests: 'Bondage, Sensory play, Roleplay.',
    healthConcerns: 'Mild asthma.',
    sessionDateTime: 'wed 20', // Must be a JS Date object
    sessionLength: '2 hours',
    identity: 'Submissive',
    experienceLevel: 'Beginner',
    recentReference: 'Mistress Jane (Session on Jan 2025)',
  },
];
